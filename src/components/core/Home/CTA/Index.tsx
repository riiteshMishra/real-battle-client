...
const FinalCta = () => {
  return (
    <section className="px-5 py-16 sm:py-20 md:py-24">
      <div className="relative mx-auto flex max-w-6xl flex-col overflow-hidden rounded-3xl border border-foreground/10 bg-foreground/[0.03] px-6 py-12 backdrop-blur-xl sm:px-10 lg:flex-row lg:items-center lg:px-14 lg:py-16">
        {/* Glow */}
