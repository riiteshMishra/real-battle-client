          ...
          return (
            <a
              ...
              className={`group rounded-xl border p-5 transition-all hover:-translate-y-0.5 ${
                {
                  orange: `border-orange-200 bg-orange-50 hover:border-orange-300 hover:shadow-orange-100/60 dark:border-orange-900/60 dark:bg-orange-950/20 dark:hover:border-orange-800`,
                  blue: `border-blue-200 bg-blue-50 hover:border-blue-300 hover:shadow-blue-100/60 dark:border-blue-900/60 dark:bg-blue-950/20 dark:hover:border-blue-800`,
                  emerald: `border-emerald-200 bg-emerald-50 hover:border-emerald-300 hover:shadow-emerald-100/60 dark:border-emerald-900/60 dark:bg-emerald-950/20 dark:hover:border-emerald-800`,
                  purple: `border-purple-200 bg-purple-50 hover:border-purple-300 hover:shadow-purple-100/60 dark:border-purple-900/60 dark:bg-purple-950/20 dark:hover:border-purple-800`,
                }[item.color]
              } `}
            >
