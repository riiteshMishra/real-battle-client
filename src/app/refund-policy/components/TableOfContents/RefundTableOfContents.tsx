          ...
          {data.sections.map((section) => (
            <li key={section.id}>
              ...
              >
                <span
                  aria-hidden="true"
                  className="h-1.5 w-1.5 shrink-0 rounded-full bg-slate-400 transition-all group-hover:bg-blue-600 group-hover:shadow-[0_0_8px_rgba(37,99,235,0.7)] dark:bg-slate-600 dark:group-hover:bg-blue-400"
                />
