  ...
  return (
    <div className="space-y-8">
      {section.subsections.map((subsection, index) => (
        <div key={index}>
          <h3 className="mb-3 flex items-center gap-x-4 text-base font-semibold tracking-tight text-slate-900 md:text-lg dark:text-slate-100">
            <ChevronRight
              aria-hidden="true"
          ...
          <ul className="space-y-3 pl-1">
            {subsection.items.map((item, itemIndex) => (
              ...
              >
                <div className="animate-check-glow mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-orange-100 dark:bg-orange-950/40">
                  <Check
                    aria-hidden="true"
